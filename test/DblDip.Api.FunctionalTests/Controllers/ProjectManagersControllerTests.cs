...
using System.Text;
using Xunit;
using static DblDip.Api.FunctionalTests.ProjectManagersControllerTests.Endpoints;
...
namespace DblDip.Api.FunctionalTests
{
    public class ProjectManagersControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateProjectManager()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Endpoints.Post.CreateProjectManager, stringContent);
