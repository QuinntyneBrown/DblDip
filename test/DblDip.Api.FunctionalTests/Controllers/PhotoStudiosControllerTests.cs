...
using System.Text;
using Xunit;
using static DblDip.Api.FunctionalTests.PhotoStudiosControllerTests.Endpoints;
...
namespace DblDip.Api.FunctionalTests
{
    public class PhotoStudiosControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreatePhotoStudio()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Endpoints.Post.CreatePhotoStudio, stringContent);
