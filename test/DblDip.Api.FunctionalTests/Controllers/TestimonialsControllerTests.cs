...
using System.Text;
using Xunit;
using static DblDip.Api.FunctionalTests.Controllers.TestimonialsControllerTests.Endpoints;
...
namespace DblDip.Api.FunctionalTests.Controllers
{
    public class TestimonialsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateTestimonial()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Endpoints.Post.CreateTestimonial, stringContent);
