...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.ClientsControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class ClientsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateClient()
        {
            ...
            var httpResponseMessage = await httpClient.PostAsync(Post.CreateClient, stringContent);
