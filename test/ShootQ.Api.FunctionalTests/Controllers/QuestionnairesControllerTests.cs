...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.QuestionnairesControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class QuestionnairesControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateQuestionnaire()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateQuestionnaire, stringContent);
