...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.WeddingQuotesControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class WeddingQuotesControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateWeddingQuote()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateWeddingQuote, stringContent);
