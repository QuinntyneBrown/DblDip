...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.VenuesControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class VenuesControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateVenue()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateVenue, stringContent);
