...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.SocialEventsControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class SocialEventsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateSocialEvent()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateSocialEvent, stringContent);
