...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.ExpensesControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class ExpensesControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateExpense()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateExpense, stringContent);
