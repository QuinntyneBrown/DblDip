...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.LibrariesControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class LibrariesControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateLibrary()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateLibrary, stringContent);
