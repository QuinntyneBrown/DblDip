...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.StudioPortraitsControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class StudioPortraitsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateStudioPortrait()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateStudioPortrait, stringContent);
