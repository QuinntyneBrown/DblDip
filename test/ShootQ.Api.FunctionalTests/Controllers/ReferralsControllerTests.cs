...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.ReferralsControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class ReferralsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateReferral()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateReferral, stringContent);
