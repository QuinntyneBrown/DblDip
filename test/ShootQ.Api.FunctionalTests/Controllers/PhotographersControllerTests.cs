...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.PhotographersControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class PhotographersControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreatePhotographer()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreatePhotographer, stringContent);
