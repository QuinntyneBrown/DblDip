...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.OrdersControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class OrdersControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateOrder()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateOrder, stringContent);
