...
using System.Text;
using Xunit;
using static ShootQ.Api.FunctionalTests.Controllers.MeetingsControllerTests.Endpoints;
...
namespace ShootQ.Api.FunctionalTests.Controllers
{
    public class MeetingsControllerTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async System.Threading.Tasks.Task Should_CreateMeeting()
        {
            ...
            var httpResponseMessage = await client.PostAsync(Post.CreateMeeting, stringContent);
