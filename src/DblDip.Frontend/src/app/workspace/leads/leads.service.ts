...
export class LeadsService {
  ...
  public getById(options: { leadId: number }): Observable<Lead> {
  ...
  public save(options: { lead: Lead }): Observable<{ leadId: number }> {
    return this._client.post<{ leadId: number }>(`${this._baseUrl}api/leads`, { lead: options.lead });
  }  
}
